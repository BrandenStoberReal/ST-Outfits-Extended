// Test file for utility functions that can be tested in isolation
// Since we can't directly import browser modules, let's test the functionality using standalone functions

// Define the functions that are in ExtensionCore.js here for testing purposes
function isAlphaNumericWithUnderscores(str: string | null | undefined): boolean {
...
function isLowerAlphaNumericWithUnderscoresAndHyphens(str: string | null | undefined): boolean {
    if (!str || typeof str !== 'string') {
        return false;
    }
