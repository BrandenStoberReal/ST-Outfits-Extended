...
export function createSettingsUI(AutoOutfitSystem, autoOutfitSystem, context) {
    ...
    const currentSettings = (settings === null || settings === void 0 ? void 0 : settings[MODULE_NAME]) || {};
                    ...
                    <div class="panel-color-section">
                        ...
                        <div class="color-setting-row">
                            ...
                            <div class="color-input-wrapper">
                                ...
                                <input type="text" id="bot-panel-primary-color" value="${((_e = currentSettings === null || currentSettings === void 0 ? void 0 : currentSettings.botPanelColors) === null || _e === void 0 ? void 0 : _e.primary) || 'linear-gradient(135deg, #6a4fc1 0%, #5a49d0 50%, #4a43c0 100%)'}">
                        ...
                        <div class="color-setting-row">
                            ...
                            <div class="color-input-wrapper">
                                <input type="color" id="bot-panel-border-color-picker" value="${((_f = currentSettings === null || currentSettings === void 0 ? void 0 : currentSettings.botPanelColors) === null || _f === void 0 ? void 0 : _f.border) || '#8a7fdb'}">
                                <input type="text" id="bot-panel-border-color" value="${((_g = currentSettings === null || currentSettings === void 0 ? void 0 : currentSettings.botPanelColors) === null || _g === void 0 ? void 0 : _g.border) || '#8a7fdb'}">
                        ...
                        <div class="color-setting-row">
                            ...
                            <div class="color-input-wrapper">
                                ...
                                <input type="text" id="bot-panel-shadow-color" value="${((_h = currentSettings === null || currentSettings === void 0 ? void 0 : currentSettings.botPanelColors) === null || _h === void 0 ? void 0 : _h.shadow) || 'rgba(106, 79, 193, 0.4)'}">
                    ...
                    <div class="panel-color-section">
                        ...
                        <div class="color-setting-row">
                            ...
                            <div class="color-input-wrapper">
                                ...
                                <input type="text" id="user-panel-primary-color" value="${((_j = currentSettings === null || currentSettings === void 0 ? void 0 : currentSettings.userPanelColors) === null || _j === void 0 ? void 0 : _j.primary) || 'linear-gradient(135deg, #1a78d1 0%, #2a68c1 50%, #1a58b1 100%)'}">
                        ...
                        <div class="color-setting-row">
                            ...
                            <div class="color-input-wrapper">
                                <input type="color" id="user-panel-border-color-picker" value="${((_k = currentSettings === null || currentSettings === void 0 ? void 0 : currentSettings.userPanelColors) === null || _k === void 0 ? void 0 : _k.border) || '#5da6f0'}">
                                <input type="text" id="user-panel-border-color" value="${((_l = currentSettings === null || currentSettings === void 0 ? void 0 : currentSettings.userPanelColors) === null || _l === void 0 ? void 0 : _l.border) || '#5da6f0'}">
                        ...
                        <div class="color-setting-row">
                            ...
                            <div class="color-input-wrapper">
                                ...
                                <input type="text" id="user-panel-shadow-color" value="${((_m = currentSettings === null || currentSettings === void 0 ? void 0 : currentSettings.userPanelColors) === null || _m === void 0 ? void 0 : _m.shadow) || 'rgba(26, 120, 209, 0.4)'}">
    ...
    function updateStatusIndicators() {
        ...
        if (typeof window.getOutfitExtensionStatus === 'function') {
            ...
            try {
                ...
                if (window.outfitTracker && (settings === null || settings === void 0 ? void 0 : settings[MODULE_NAME])) {
                    $('#status-core').removeClass('status-loading').addClass('status-active').text('Active');
                }
                else {
                    $('#status-core').removeClass('status-loading').addClass('status-inactive').text('Inactive');
    ...
    (() => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const LLMUtilityModule = yield import('../utils/LLMUtility.js');
            const profiles = yield LLMUtilityModule.ConnectionProfileHelper.getAllProfiles(context);
            ...
            if (autoOutfitConnectionProfile && !profiles.some((p) => p.id === autoOutfitConnectionProfile)) {
    ...
    $('#outfit-process-btn').on('click', function () {
        return __awaiter(this, void 0, void 0, function* () {
            if (hasAutoSystem && autoOutfitSystem) {
                try {
                    ...
                    yield autoOutfitSystem.manualTrigger();
