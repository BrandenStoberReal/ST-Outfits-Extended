    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        `,
            ...
            if (typeof autoOutfitSystem !== 'undefined' && autoOutfitSystem.constructor.name !== 'DummyAutoOutfitSystem') {
                SlashCommandParser.addCommandObject(SlashCommand.fromProps({
                    ...
                    callback: function (args, value) {
                        return __awaiter(this, void 0, void 0, function* () {
                            const arg = (value === null || value === void 0 ? void 0 : value.toString().toLowerCase()) || '';
                            const isQuiet = (args === null || args === void 0 ? void 0 : args.quiet) === true;
                    ...
                    callback: function (args, value) {
                        return __awaiter(this, void 0, void 0, function* () {
                            ...
                            if (window.autoOutfitSystem) {
                                ...
                                const length = ((_a = autoOutfitSystem.systemPrompt) === null || _a === void 0 ? void 0 : _a.length) || 0;
            ...
            `,
                ...
                SlashCommandParser.addCommandObject(SlashCommand.fromProps({
                    ...
                    callback: function (args) {
                        return __awaiter(this, void 0, void 0, function* () {
                            if (window.autoOutfitSystem) {
                                const result = yield autoOutfitSystem.manualTrigger();
            ...
            SlashCommandParser.addCommandObject(SlashCommand.fromProps({
                ...
                callback: function (args, value) {
                    return __awaiter(this, void 0, void 0, function* () {
                        const outfitName = (value === null || value === void 0 ? void 0 : value.toString().trim()) || '';
                        const isQuiet = (args === null || args === void 0 ? void 0 : args.quiet) === true;
                        if (!outfitName) {
                        ...
                        try {
                            ...
                            let message = yield botManager.loadPreset(outfitName);
                            ...
                            let userMessage = yield userManager.loadPreset(outfitName);
            ...
            SlashCommandParser.addCommandObject(SlashCommand.fromProps({
                ...
                callback: function (args, value) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const params = (value === null || value === void 0 ? void 0 : value.toString().trim()) || '';
        ...
        `,
            ...
            SlashCommandParser.addCommandObject(SlashCommand.fromProps({
                ...
                callback: function (args, value) {
                    return __awaiter(this, void 0, void 0, function* () {
                        const isQuiet = (args === null || args === void 0 ? void 0 : args.quiet) === true;
                        const slot = (value === null || value === void 0 ? void 0 : value.toString().trim()) || '';
                        if (!botManager.slots.includes(slot)) {
                            const error = `Invalid slot: ${slot}. Valid slots: ${botManager.slots.join(', ')}`;
                            if (!isQuiet) {
                                toastr.error(error, 'Outfit System');
        ...
        `,
            ...
            SlashCommandParser.addCommandObject(SlashCommand.fromProps({
                ...
                callback: function (args, value) {
                    return __awaiter(this, void 0, void 0, function* () {
                        const isQuiet = (args === null || args === void 0 ? void 0 : args.quiet) === true;
                        const presetName = (value === null || value === void 0 ? void 0 : value.toString().trim()) || '';
                        if (!presetName) {
