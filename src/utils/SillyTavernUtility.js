 ...
 * @returns {object|null} The current character object or null if not found.
 */
export function getCurrentCharacter() {
    const characterId = SillyTavernApi.getContext().characterId;

    if (characterId !== undefined) {
        return SillyTavernApi.getCharacters()[characterId];
    }
    return null;
}

/**
 * Gets a character by its ID (index).
 * @param {number} id The ID (index) of the character.
...
/**
 * Gets the URL of a character's avatar.
...
/**
 * Gets the character's data from the `data` field.
 * @param {object} character The character object.
 * @returns {object|null} The character data object or null if not found.
 */
...
/**
 * Gets the character's extensions data.
 * @param {object} character The character object.
 * @returns {object|null} The extensions data object or null if not found.
 */
export function getCharacterExtensions(character) {
    return character.data?.extensions || null;
}

/**
 * Gets the character's character book.
 * @param {object} character The character object.
 * @returns {object|null} The character book object or null if not found.
 */
export function getCharacterBook(character) {
    return character.data?.character_book || null;
}

/**
 * Gets the last message from the chat.
 * @returns {object|null} The last message object or null if the chat is empty.
 */
 ...
 */
export function findMessagesByUser(userName) {
    const chat = SillyTavernApi.getChat();

    return chat.filter(message => message.is_user && message.name === userName);
}

/**
 * Finds all messages sent by a specific character.
 * @param {string} characterName The name of the character.
 * @returns {object[]} An array of message objects.
 */
export function findMessagesByCharacter(characterName) {
    const chat = SillyTavernApi.getChat();

    return chat.filter(message => !message.is_user && message.name === characterName);
}
...
/**
 * Checks if a message is from the character.
 * @param {object} message The message object.
 * @returns {boolean} True if the message is from the character, false otherwise.
 */
 ...
 * @param {object} message The message object.
 * @returns {boolean} True if the message is a system message, false otherwise.
 */
