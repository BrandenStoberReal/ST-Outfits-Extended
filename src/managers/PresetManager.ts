...
class PresetManager {
    ...
    static loadPreset(
        ...
        return {...presets[presetName]}; // Return a copy to avoid direct manipulation
    }
    ...
    static getDefaultPreset(
        ...
        if (presets && presets['default']) {
            return {...presets['default']}; // Return a copy to avoid direct manipulation
        }
